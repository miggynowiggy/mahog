...
var grammar = {
    ...
    {"name": "desired_statement", "symbols": ["data_declare", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "mixed_expressions", "symbols": [(lexer.has("string_lit") ? {type: "string_lit"} : string_lit), "additional_str_method_expr"]},
    ...
    {"name": "mixed_expressions", "symbols": ["typecast_str", "additional_str_method_expr"]},
    ...
    {"name": "additional_str_method_expr", "symbols": [(lexer.has("period") ? {type: "period"} : period), "str_methods_yes"]},
    {"name": "additional_str_method_expr", "symbols": ["atChar_expr_add"]},
    {"name": "str_methods_yes", "symbols": ["atPos_method", "atChar_expr_add"]},
    {"name": "str_methods_yes", "symbols": ["atChar_method", "init_expr_add"]},
    {"name": "atPos_method_yes", "symbols": [(lexer.has("period") ? {type: "period"} : period), "atPos_method"]},
    {"name": "atPos_method_yes", "symbols": []},
    {"name": "atChar_method_yes", "symbols": [(lexer.has("period") ? {type: "period"} : period), "atChar_method"]},
    {"name": "atChar_method_yes", "symbols": []},
    ...
    {"name": "add_choices", "symbols": ["init_operands1", "init_expr_add"]},
    {"name": "add_choices", "symbols": ["atChar_operands1", "atChar_expr_add"]},
    {"name": "add_choices", "symbols": ["ids", "init_expr_add"]},
    {"name": "add_choices", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "add_choices", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    {"name": "data_declare", "symbols": ["data_id"]},
    {"name": "data_choices", "symbols": [(lexer.has("assign_only_op") ? {type: "assign_only_op"} : assign_only_op), "assignable_values"]},
    {"name": "data_choices", "symbols": ["function_dec"]},
    {"name": "data_choices", "symbols": []},
    {"name": "num_choices", "symbols": [(lexer.has("assign_only_op") ? {type: "assign_only_op"} : assign_only_op), "num_values"]},
    ...
    {"name": "str_choices", "symbols": [(lexer.has("assign_only_op") ? {type: "assign_only_op"} : assign_only_op), "str_values"]},
    ...
    {"name": "data_id", "symbols": [(lexer.has("boolean_datatype") ? {type: "boolean_datatype"} : boolean_datatype), (lexer.has("id") ? {type: "id"} : id), "data_choices"]},
    {"name": "data_id", "symbols": [(lexer.has("seed_datatype") ? {type: "seed_datatype"} : seed_datatype), (lexer.has("id") ? {type: "id"} : id), "data_choices"]},
    ...
    {"name": "object_content", "symbols": ["data_id", (lexer.has("colon") ? {type: "colon"} : colon), "assignable_values", (lexer.has("comma") ? {type: "comma"} : comma), "append_property"]},
    ...
    {"name": "bool_expressions", "symbols": ["bool_operand", "bool_expr_add"]},
    {"name": "bool_expr_add", "symbols": ["operator", "bool_expressions"]},
    {"name": "bool_expr_add", "symbols": []},
    {"name": "bool_operand", "symbols": ["bool_operand_no_paren"]},
    {"name": "bool_operand", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "mixed_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    ...
    {"name": "bool_operand_no_paren", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "bool_operand"]},
    ...
    {"name": "relate_expressions", "symbols": ["relate_operands", "relate_expr_add"]},
    {"name": "relate_expr_add", "symbols": ["relate_op", "relate_expressions"]},
    {"name": "relate_expr_add", "symbols": []},
    {"name": "relate_operands", "symbols": [(lexer.has("bool_lit") ? {type: "bool_lit"} : bool_lit)]},
    {"name": "relate_operands", "symbols": ["number_literals"]},
    {"name": "relate_operands", "symbols": ["ids"]},
    {"name": "relate_operands", "symbols": ["typecast_num"]},
    {"name": "relate_operands", "symbols": ["typecast_bol"]},
    {"name": "relate_operands", "symbols": ["trim_function"], "postprocess": id},
    {"name": "relate_operands", "symbols": ["size_function"], "postprocess": id},
    {"name": "relate_operands", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "bool_operand"]},
    {"name": "relate_operands", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "init_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    {"name": "logic_expressions", "symbols": ["logic_operands", "logic_expr_add"]},
    {"name": "logic_expr_add", "symbols": ["logical_op", "logic_expressions"]},
    {"name": "logic_expr_add", "symbols": []},
    {"name": "logic_operands", "symbols": [(lexer.has("bool_lit") ? {type: "bool_lit"} : bool_lit)]},
    {"name": "logic_operands", "symbols": ["number_literals"]},
    {"name": "logic_operands", "symbols": ["ids"]},
    {"name": "logic_operands", "symbols": ["typecast_num"]},
    {"name": "logic_operands", "symbols": ["typecast_bol"]},
    {"name": "logic_operands", "symbols": ["trim_function"], "postprocess": id},
    {"name": "logic_operands", "symbols": ["size_function"], "postprocess": id},
    {"name": "logic_operands", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "bool_operand"]},
    {"name": "logic_operands", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "mixed_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    ...
    {"name": "init_operands", "symbols": [(lexer.has("id") ? {type: "id"} : id), "id_choices_atPos"]},
    ...
    {"name": "init_operands1", "symbols": [(lexer.has("string_lit") ? {type: "string_lit"} : string_lit), (lexer.has("period") ? {type: "period"} : period), "atChar_method"]},
    {"name": "init_operands1", "symbols": ["typecast_num"]},
    {"name": "init_operands1", "symbols": ["typecast_str", (lexer.has("period") ? {type: "period"} : period), "atChar_method"]},
    {"name": "init_operands1", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "init_operands"]},
    {"name": "init_operands1", "symbols": ["typecast_num"]},
    ...
    {"name": "id_choices_atPos", "symbols": ["id_choices_atPos_yes"]},
    {"name": "id_choices_atPos", "symbols": ["object_access_atPos"]},
    {"name": "id_choices_atPos", "symbols": []},
    {"name": "id_choices_atPos_yes", "symbols": ["array_access", "object_null_atPos"]},
    {"name": "id_choices_atPos_yes", "symbols": ["call_function"]},
    {"name": "object_null_atPos", "symbols": ["object_access_atPos"]},
    {"name": "object_null_atPos", "symbols": []},
    {"name": "object_access_atPos", "symbols": [(lexer.has("period") ? {type: "period"} : period), "object_atPos"]},
    {"name": "object_atPos", "symbols": [(lexer.has("id") ? {type: "id"} : id), "object_arr"]},
    {"name": "object_atPos", "symbols": ["atChar_method"]},
    ...
    {"name": "atChar_expressions", "symbols": ["atChar_operands", "atPos_method_yes", "atChar_expr_add"]},
    {"name": "atChar_expr_add", "symbols": ["str_operator", "atChar_expressions"]},
    {"name": "atChar_expr_add", "symbols": []},
    {"name": "atChar_operands", "symbols": [(lexer.has("id") ? {type: "id"} : id), "id_choices_atChar"]},
    ...
    {"name": "id_choices_atChar", "symbols": ["id_choices_atChar_yes"]},
    {"name": "id_choices_atChar", "symbols": ["object_access_atChar"]},
    {"name": "id_choices_atChar", "symbols": []},
    {"name": "id_choices_atChar_yes", "symbols": ["array_access", "object_null_atChar"]},
    {"name": "id_choices_atChar_yes", "symbols": ["call_function"]},
    {"name": "object_null_atChar", "symbols": ["object_access_atChar"]},
    {"name": "object_null_atChar", "symbols": []},
    {"name": "object_access_atChar", "symbols": [(lexer.has("period") ? {type: "period"} : period), "object_atChar"]},
    {"name": "object_atChar", "symbols": [(lexer.has("id") ? {type: "id"} : id), "object_arr"]},
    ...
    {"name": "id_choices", "symbols": ["id_choices1"]},
    {"name": "id_choices", "symbols": ["id_choices1"]},
    {"name": "id_choices", "symbols": []},
    {"name": "id_choices1", "symbols": ["array_access", "object_null"]},
    {"name": "id_choices1", "symbols": ["call_function"]},
    ...
    {"name": "array_access", "symbols": [(lexer.has("L_sqr") ? {type: "L_sqr"} : L_sqr), "init_expressions", (lexer.has("R_sqr") ? {type: "R_sqr"} : R_sqr), "arr_2D"]},
    {"name": "arr_2D", "symbols": [(lexer.has("L_sqr") ? {type: "L_sqr"} : L_sqr), "init_expressions", (lexer.has("R_sqr") ? {type: "R_sqr"} : R_sqr)]},
    {"name": "arr_2D", "symbols": []},
