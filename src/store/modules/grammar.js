...
var grammar = {
    ...
    {"name": "optional_expr", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "init_expressions"]},
    {"name": "optional_expr", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "mixed_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "mixed_adds"]},
    ...
    {"name": "mixed_adds", "symbols": [(lexer.has("subtract_op") ? {type: "subtract_op"} : subtract_op), "init_expressions"]},
    {"name": "mixed_adds", "symbols": [(lexer.has("multiply_op") ? {type: "multiply_op"} : multiply_op), "init_expressions"]},
    {"name": "mixed_adds", "symbols": [(lexer.has("divide_op") ? {type: "divide_op"} : divide_op), "init_expressions"]},
    {"name": "mixed_adds", "symbols": [(lexer.has("modulo_op") ? {type: "modulo_op"} : modulo_op), "init_expressions"]},
    {"name": "mixed_adds", "symbols": ["relate_op_num", "init_expressions"]},
    {"name": "mixed_adds", "symbols": ["relate_op_bool", "mixed_expressions"]},
    {"name": "mixed_adds", "symbols": ["logical_op", "init_expressions"]},
    ...
    {"name": "num_choices", "symbols": [(lexer.has("add_assign_op") ? {type: "add_assign_op"} : add_assign_op), "init_expressions", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    {"name": "num_choices", "symbols": ["assign_operators", "init_expressions", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "init_expressions", "symbols": ["init_optional_nega", "init_operands", "init_expr_add"]},
    ...
    {"name": "init_expr_add", "symbols": [(lexer.has("unary") ? {type: "unary"} : unary)]},
    ...
    {"name": "index_arith_expressions", "symbols": ["index_arith_operand", "arith_expr_add"]},
    ...
    {"name": "index_arith_expr_add", "symbols": [(lexer.has("unary") ? {type: "unary"} : unary)]},
    {"name": "index_arith_operand", "symbols": [(lexer.has("num_lit") ? {type: "num_lit"} : num_lit)]},
    {"name": "index_arith_operand", "symbols": ["option_sign", "option_negas"]},
    {"name": "arith_expressions", "symbols": ["arith_operand", "arith_expr_add"]},
    {"name": "arith_expr_add", "symbols": ["operator", "arith_expressions"]},
    {"name": "arith_expr_add", "symbols": [(lexer.has("unary") ? {type: "unary"} : unary)]},
    ...
    {"name": "option_negas", "symbols": ["ids"], "postprocess": id},
    ...
    {"name": "option_negas", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "arith_operand"]},
    ...
    {"name": "str_operator", "symbols": ["arith_op"], "postprocess": id},
