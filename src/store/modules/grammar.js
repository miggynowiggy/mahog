...
var grammar = {
    ...
    {"name": "index_arith_operand", "symbols": ["ids"], "postprocess": id},
    {"name": "index_arith_operand", "symbols": ["typecast_num"]},
    {"name": "index_arith_operand", "symbols": ["trim_function"], "postprocess": id},
    {"name": "index_arith_operand", "symbols": ["size_function"], "postprocess": id},
    {"name": "index_arith_operand", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "arith_operand"]},
    {"name": "index_arith_operand", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "arith_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    {"name": "index_arith_operand", "symbols": ["bool_expr_no_paren"]},
