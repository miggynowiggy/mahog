...
var grammar = {
    ...
    {"name": "id_assign", "symbols": ["ids", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    {"name": "id_assign", "symbols": ["ids", "assign_op", "assignable_values", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "expressions", "symbols": ["operator", "operand", "expressions"]},
    ...
    {"name": "operand", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op)]},
    {"name": "operand", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "operand"]},
    {"name": "operand", "symbols": [(lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    ...
    {"name": "literals", "symbols": [(lexer.has("string_lit") ? {type: "string_lit"} : string_lit), "period_char", "str_methods"]},
    ...
    {"name": "ids", "symbols": [(lexer.has("id") ? {type: "id"} : id), "unary", "array_access", "period_char", "object_access", "arr_methods", "str_methods", "call_function"]},
    {"name": "object_access", "symbols": ["ids"]},
    ...
    {"name": "input_choices", "symbols": [(lexer.has("string_lit") ? {type: "string_lit"} : string_lit), "period_char", "str_methods"]},
    ...
    {"name": "elif_statement", "symbols": [(lexer.has("elif") ? {type: "elif"} : elif), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope", "else_statement"]},
