...
var grammar = {
    ...
    {"name": "bool_operand", "symbols": ["literals"], "postprocess": id},
    {"name": "bool_operand", "symbols": ["ids"], "postprocess": id},
    {"name": "bool_operand", "symbols": ["typecast_num"]},
    {"name": "bool_operand", "symbols": ["trim_function"], "postprocess": id},
    {"name": "bool_operand", "symbols": ["size_function"], "postprocess": id},
    {"name": "bool_operand", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "bool_operand"]},
    {"name": "bool_operand", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "bool_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    ...
    {"name": "str_operand", "symbols": ["typecast_num"]},
    {"name": "str_operand", "symbols": ["trim_function"], "postprocess": id},
    {"name": "str_operand", "symbols": ["size_function"], "postprocess": id},
    {"name": "str_operand", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "str_operand"]},
    ...
    {"name": "if_statement", "symbols": [(lexer.has("if_word") ? {type: "if_word"} : if_word), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "bool_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope", "elif_statement", "else_statement"]},
    {"name": "elif_statement", "symbols": [(lexer.has("elif") ? {type: "elif"} : elif), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "bool_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
    ...
    {"name": "loop_statement", "symbols": [(lexer.has("during") ? {type: "during"} : during), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "bool_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
