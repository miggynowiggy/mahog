...
var grammar = {
    ...
    {"name": "operand", "symbols": ["not_options"]},
    {"name": "operand", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren)]},
    {"name": "operand", "symbols": ["operand", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    {"name": "not_options", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "operand"]},
