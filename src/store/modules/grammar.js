...
var grammar = {
    ...
    {"name": "assignable_values", "symbols": ["arith_expressions"]},
    {"name": "assignable_values", "symbols": ["str_expressions"]},
    {"name": "assignable_values", "symbols": ["bool_expressions"]},
    ...
    {"name": "bool_expr_add", "symbols": ["bool_operator", "if_loop_expressions"]},
...
<<<<<<< Updated upstream
    {"name": "bool_operand", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "expressions"]},
=======
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
    {"name": "str_operator", "symbols": ["relate_op"], "postprocess": id},
=======
...
<<<<<<< Updated upstream
    {"name": "expressions", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "paren_expressions"]},
    {"name": "paren_expressions", "symbols": ["arith_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "arith_expr_add_paren"]},
    {"name": "paren_expressions", "symbols": ["str_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "str_expr_add_paren"]},
    {"name": "paren_expressions", "symbols": ["bool_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "bool_expr_add_paren"]},
    {"name": "paren_expressions", "symbols": ["ids", "id_expr_add", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "id_expr_add_paren"]},
=======
    ...
    {"name": "if_loop_expressions", "symbols": ["if_loop_operands", "bool_expr_add"]},
    {"name": "if_loop_expressions", "symbols": [(lexer.has("not_op") ? {type: "not_op"} : not_op), "if_loop_operands", "bool_expr_add"]},
    {"name": "if_loop_operands", "symbols": ["bool_expressions"], "postprocess": id},
    {"name": "if_loop_operands", "symbols": ["str_expressions"], "postprocess": id},
    {"name": "if_loop_operands", "symbols": ["arith_expressions"], "postprocess": id},
    {"name": "if_loop_operands", "symbols": ["ids"], "postprocess": id},
    {"name": "if_loop_operands", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "if_loop_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
    {"name": "init_expressions", "symbols": ["init_operands", "arith_expr_add"]},
    {"name": "init_operands", "symbols": ["arith_expressions"], "postprocess": id},
...
>>>>>>> Stashed changes
    ...
    {"name": "bool_expr_add_paren", "symbols": ["bool_operator", "bool_expr_add_paren_yes"]},
    {"name": "bool_expr_add_paren", "symbols": []},
    {"name": "bool_expr_add_paren_yes", "symbols": ["bool_expressions"]},
    {"name": "bool_expr_add_paren_yes", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "bool_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
<<<<<<< Updated upstream
    {"name": "id_expr_add", "symbols": ["operator", "array_values"]},
    {"name": "id_expr_add", "symbols": []},
    {"name": "id_expr_add_paren", "symbols": ["ids", "id_expr_add_paren_yes"]},
    {"name": "id_expr_add_paren", "symbols": []},
    {"name": "id_expr_add_paren_yes", "symbols": ["expressions"]},
    {"name": "id_expr_add_paren_yes", "symbols": [(lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
=======
>>>>>>> Stashed changes
    ...
    {"name": "array_contents", "symbols": ["array_values", "append_element"]},
    {"name": "array_contents", "symbols": [(lexer.has("L_sqr") ? {type: "L_sqr"} : L_sqr), "array_values", "append_element_2d_yes", (lexer.has("R_sqr") ? {type: "R_sqr"} : R_sqr), "append_element"]},
    {"name": "array_contents", "symbols": []},
<<<<<<< Updated upstream
    {"name": "array_values", "symbols": ["arith_expressions"], "postprocess": id},
    {"name": "array_values", "symbols": ["str_expressions"], "postprocess": id},
    {"name": "array_values", "symbols": ["bool_expressions"], "postprocess": id},
    {"name": "array_values", "symbols": ["expressions"], "postprocess": id},
=======
    {"name": "array_values", "symbols": ["expressions"]},
    {"name": "array_values", "symbols": ["arith_expressions"]},
    {"name": "array_values", "symbols": ["str_expressions"]},
    {"name": "array_values", "symbols": ["bool_expressions"]},
>>>>>>> Stashed changes
    {"name": "append_element", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), "array_contents"]},
    {"name": "append_element", "symbols": []},
    {"name": "append_element_2d_yes", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), "array_values", "append_element_2d_yes"]},
    ...
    {"name": "trim_function", "symbols": [(lexer.has("trim") ? {type: "trim"} : trim), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "trim_param", (lexer.has("comma") ? {type: "comma"} : comma), "arith_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "output_statement", "symbols": [(lexer.has("carve") ? {type: "carve"} : carve), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "array_values", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
...
<<<<<<< Updated upstream
    {"name": "if_statement", "symbols": [(lexer.has("if_word") ? {type: "if_word"} : if_word), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "array_values", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope", "elif_statement", "else_statement"]},
    {"name": "elif_statement", "symbols": [(lexer.has("elif") ? {type: "elif"} : elif), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "array_values", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
    ...
    {"name": "loop_statement", "symbols": [(lexer.has("during") ? {type: "during"} : during), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "array_values", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
    ...
    {"name": "init_loop", "symbols": [(lexer.has("number_datatype") ? {type: "number_datatype"} : number_datatype), (lexer.has("id") ? {type: "id"} : id), (lexer.has("assign_only_op") ? {type: "assign_only_op"} : assign_only_op), "array_values"]},
    {"name": "init_loop", "symbols": [(lexer.has("id") ? {type: "id"} : id), (lexer.has("assign_only_op") ? {type: "assign_only_op"} : assign_only_op), "array_values"]},
=======
    {"name": "if_statement", "symbols": [(lexer.has("if_word") ? {type: "if_word"} : if_word), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "if_loop_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope", "elif_statement", "else_statement"]},
    {"name": "elif_statement", "symbols": [(lexer.has("elif") ? {type: "elif"} : elif), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "if_loop_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
    {"name": "elif_statement", "symbols": []},
    {"name": "else_statement", "symbols": [(lexer.has("else_word") ? {type: "else_word"} : else_word), "block_scope"]},
    {"name": "else_statement", "symbols": []},
    {"name": "loop_statement", "symbols": [(lexer.has("during") ? {type: "during"} : during), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "if_loop_expressions", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
    {"name": "loop_statement", "symbols": [(lexer.has("cycle") ? {type: "cycle"} : cycle), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "cycle_condition", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren), "block_scope"]},
    {"name": "cycle_condition", "symbols": ["init_loop", (lexer.has("terminator") ? {type: "terminator"} : terminator), "cond_loop", (lexer.has("terminator") ? {type: "terminator"} : terminator), "paren_unary"]},
...
>>>>>>> Stashed changes
    ...
    {"name": "cond_loop", "symbols": ["bool_expressions"]},
