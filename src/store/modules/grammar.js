...
var grammar = {
    ...
    {"name": "type_casting", "symbols": [(lexer.has("typecase") ? {type: "typecase"} : typecase), (lexer.has("L_paren") ? {type: "L_paren"} : L_paren), "all_datatype", (lexer.has("R_paren") ? {type: "R_paren"} : R_paren)]},
