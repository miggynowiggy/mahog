...
var grammar = {
    ...
    {"name": "object_content", "symbols": [(lexer.has("number_datatype") ? {type: "number_datatype"} : number_datatype), (lexer.has("id") ? {type: "id"} : id), (lexer.has("colon") ? {type: "colon"} : colon), "mixed_expressions", (lexer.has("comma") ? {type: "comma"} : comma), "append_property"]},
    {"name": "object_content", "symbols": [(lexer.has("string_datatype") ? {type: "string_datatype"} : string_datatype), (lexer.has("id") ? {type: "id"} : id), (lexer.has("colon") ? {type: "colon"} : colon), "mixed_expressions", (lexer.has("comma") ? {type: "comma"} : comma), "append_property"]},
    {"name": "object_content", "symbols": [(lexer.has("boolean_datatype") ? {type: "boolean_datatype"} : boolean_datatype), (lexer.has("id") ? {type: "id"} : id), (lexer.has("colon") ? {type: "colon"} : colon), "mixed_expressions", (lexer.has("comma") ? {type: "comma"} : comma), "append_property"]},
